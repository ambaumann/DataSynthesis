...
import io.connectedhealth.idaas.datasynthesis.openapi.auth.Authentication;
import io.connectedhealth.idaas.datasynthesis.openapi.auth.HttpBasicAuth;
import io.connectedhealth.idaas.datasynthesis.openapi.auth.HttpBearerAuth;
import io.connectedhealth.idaas.datasynthesis.openapi.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:3001/api/querydata";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/4.0.0-SNAPSHOT/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:3001/api/querydata
